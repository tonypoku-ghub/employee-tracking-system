...
class Company {
  ...
  async process(initAnswer) {
    if (initAnswer.todo === "view_all_departments") {
      ...
      const dept_list = await this.dao.viewAllDepartments_inquirer();

      console.log("questions.add_role-dept_list", dept_list);

      console.log("questions.add_role-b4", questions.add_role);
      ...
      console.log("questions.add_role", questions.add_role);
